...
#include "CombatUI.h"
#include "AthleticYouthBattle.generated.h"

/**
 * 
 */
UCLASS()
class CARDLORD_HIGHSCHOOL_API AAthleticYouthBattle : public AGameMode
{
	GENERATED_BODY()
...
public:
    AAthleticYouthBattle(const class FObjectInitializer& ObjectInitializer);
