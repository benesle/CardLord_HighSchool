...
// Sets default values
AMyEnemyNerd::AMyEnemyNerd()
{
	// Set this pawn to call Tick() every frame.  You can turn this off to improve performance if you don't need it.
	PrimaryActorTick.bCanEverTick = true;

	OnActorHit.AddDynamic(this, &AMyEnemyNerd::OnHit);
	OnActorBeginOverlap.AddDynamic(this, &AMyEnemyNerd::OnOverlapBegin);

}

// Called when the game starts or when spawned
void AMyEnemyNerd::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AMyEnemyNerd::Tick(float DeltaTime)
{
...
void AMyEnemyNerd::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	Super::SetupPlayerInputComponent(PlayerInputComponent);

}

void AMyEnemyNerd::Update()
{
...
void AMyEnemyNerd::OnHit(AActor* SelfActor, AActor* OtherActor, FVector NormalImpulse, const FHitResult& Hit)
{
...
void AMyEnemyNerd::OnOverlapBegin(AActor* OverlappedActor, AActor* OtherActor)
{
