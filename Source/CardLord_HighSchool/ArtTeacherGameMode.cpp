...
AArtTeacherGameMode::AArtTeacherGameMode(const class FObjectInitializer& ObjectInitializer)
...
void AArtTeacherGameMode::TestCombat()
{
	//Find enemyData
	...
	//Find enemis
	FEnemyData* row = enemyTable->FindRow<FEnemyData>(TEXT("P7"), TEXT("LookupEnemyData"));
	enemyTable->FindRow<FEnemyData>(TEXT("P7"), TEXT("LookupEnemyData"));

	if (row == NULL)
	{
		UE_LOG(LogTemp, Error, TEXT("Enemy ID 'P7' not found!"));
		return;
	}
	else
	{
	...
	FEnemyData* row1 = enemyTable->FindRow<FEnemyData>(TEXT("P8"), TEXT("LookupEnemyData"));

	if (row1 == NULL)
	{
		UE_LOG(LogTemp, Error, TEXT("Enemy ID 'P8' not found!"));
		return;
	}
	else
	{
...
void AArtTeacherGameMode::BeginPlay()
{
...
void AArtTeacherGameMode::Tick(float DeltaTime)
{
