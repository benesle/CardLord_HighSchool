...
void AGymTeacherBattle::BeginPlay()
{
...
void AGymTeacherBattle::Tick(float DeltaTime)
{
...
void AGymTeacherBattle::TestCombat()
{
	//Find enemyData
	...
	//Find enemis
	FEnemyData* row = enemyTable->FindRow<FEnemyData>(TEXT("P9"), TEXT("LookupEnemyData"));
	enemyTable->FindRow<FEnemyData>(TEXT("P9"), TEXT("LookupEnemyData"));
	...
	FEnemyData* row1 = enemyTable->FindRow<FEnemyData>(TEXT("P1"), TEXT("LookupEnemyData"));
...
AGymTeacherBattle::AGymTeacherBattle(const FObjectInitializer& ObjectInitializer)
{
