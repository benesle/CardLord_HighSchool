...
void AAthleticYouthBattle::BeginPlay()
{
...
void AAthleticYouthBattle::Tick(float DeltaTime)
{
...
void AAthleticYouthBattle::TestCombat()
{
	//Find enemyData
	...
	FEnemyData* row1 = enemyTable->FindRow<FEnemyData>(TEXT("P3"), TEXT("LookupEnemyData"));
...
AAthleticYouthBattle::AAthleticYouthBattle(const FObjectInitializer& ObjectInitializer)
{
